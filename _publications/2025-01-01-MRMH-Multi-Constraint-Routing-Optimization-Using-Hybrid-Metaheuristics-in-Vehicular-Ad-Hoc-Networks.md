...
---
Use [Google Scholar](https://scholar.google.com/scholar?q=MRMH:+Multi+Constraint+Routing+Optimization+Using+Hybrid+Metaheuristics+in+Vehicular+Ad+Hoc+Networks){:target="_blank"} for full citation