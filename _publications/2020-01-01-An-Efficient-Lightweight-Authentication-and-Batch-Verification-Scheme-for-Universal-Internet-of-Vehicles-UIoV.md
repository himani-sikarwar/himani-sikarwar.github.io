...
---
Use [Google Scholar](https://scholar.google.com/scholar?q=An+Efficient+Lightweight+Authentication+and+Batch+Verification+Scheme+for+Universal+Internet+of+Vehicles+(UIoV)){:target="_blank"} for full citation