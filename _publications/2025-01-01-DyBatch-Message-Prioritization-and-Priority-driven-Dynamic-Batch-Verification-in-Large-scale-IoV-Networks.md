...
---
Use [Google Scholar](https://scholar.google.com/scholar?q=DyBatch:+Message+Prioritization+and+Priority+driven+Dynamic+Batch+Verification+in+Large+scale+IoV+Networks){:target="_blank"} for full citation